...
# 启动本地开发服务器
CMD wrangler dev server.js --local --var OPENAI_GPT4:$OPENAI_GPT4 OPENAI_KEY4:$OPENAI_KEY4 OPENAI_GPT35_TURBO:$OPENAI_GPT35_TURBO  OPENAI_KEY35_TURBO:$OPENAI_KEY35_TURBO SHOULD_USE_OPENAI:$SHOULD_USE_OPENAI SHOULD_MAKE_LINE:$SHOULD_MAKE_LINE
